...
export default function ApiRoutes() {
  return (
    <div className="max-w-4xl mx-auto px-6 py-24 text-zinc-300">
      <div className="mb-12">
        <h1 className="text-4xl font-bold text-white mb-4">API Routes</h1>
        <p className="text-xl text-zinc-400">Serverless functions for your backend logic.</p>
      </div>

      <div className="prose prose-invert max-w-none">
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-white mb-4">Creating an API</h2>
          <p className="mb-4">
            Any file inside <code className="text-indigo-400">pages/api/*</code> is treated as an API endpoint, not a UI page.
            These functions run on the server-side only.
          </p>

          <div className="bg-black/50 border border-white/10 rounded-xl p-4 font-mono text-sm overflow-x-auto relative">
        ...
        <section className="mb-12">
          ...
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <li className="bg-white/5 p-4 rounded-xl">
              <strong className="text-white block mb-1">Zero Config</strong>
            ...
            <li className="bg-white/5 p-4 rounded-xl">
              <strong className="text-white block mb-1">Middlewares</strong>
              Easily wrap handlers for Auth, CORS, or Logging.
            </li>
            <li className="bg-white/5 p-4 rounded-xl">
              <strong className="text-white block mb-1">Database Ready</strong>
