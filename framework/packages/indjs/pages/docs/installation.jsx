  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-24 text-zinc-300">
      <div className="mb-12">
        ...
        <p className="text-xl text-zinc-400">Get up and running with INDJS in seconds.</p>
      </div>
      ...
      <div className="prose prose-invert max-w-none">
        ...
        <section className="mb-12">
          ...
          <div className="bg-black/50 border border-white/10 rounded-xl p-4 font-mono text-sm text-indigo-300 mb-6">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-white mb-4">Running Locally</h2>
          <div className="space-y-4">
            <div>
              <h3 className="text-lg font-semibold text-white mb-2">Web Development</h3>
              <div className="bg-black/50 border border-white/10 rounded-xl p-4 font-mono text-sm text-white mb-2">
                npm run dev
              </div>
              <p className="text-sm">Starts server at <code className="text-indigo-400">http://localhost:3000</code></p>
            </div>
            ...
            <div>
              <h3 className="text-lg font-semibold text-white mb-2">Desktop Development</h3>
              <div className="bg-black/50 border border-white/10 rounded-xl p-4 font-mono text-sm text-white mb-2">
                npm run desktop:dev
              </div>
