...
npm run dev`}
            ...
            <p style={ui.p}>
              ...
              <code style={ui.code}>http://localhost:3000</code>
            </p>
          </div>
          ...
          <div style={ui.section}>
            ...
            <ul style={ui.ul}>
              <li style={ui.li}>
                <strong>Node.js:</strong> Version 16.0.0 or higher
              </li>
              <li style={ui.li}>
                <strong>npm:</strong> Version 7.0.0 or higher (or yarn/pnpm)
              </li>
              <li style={ui.li}>
          ...
          <div style={ui.section}>
            ...
            <p style={ui.p}>If you prefer to set up your project manually:</p>
...
npm install --save-dev @types/react @types/react-dom typescript`}
  ...
  "scripts": {
    ...
    "test": "indjs test"
            ...
            <p style={ui.p}>
              Create a <code style={ui.code}>pages</code> directory and add an{" "}
              <code style={ui.code}>index.jsx</code> file:
            </p>
            <div style={ui.codeBlock}>
              {`// pages/index.jsx
import React from 'react';
...
└── README.md`}
          ...
          <div style={ui.section}>
            ...
            <p style={ui.p}>
              INDJS works out of the box with zero configuration, but you can
              customize it with an <code style={ui.code}>indjs.config.js</code>{" "}
              file:
            </p>
            <div style={ui.codeBlock}>
              {`// indjs.config.js
    ...
    minify: true
          ...
          <div style={ui.info}>
            ...
            <p style={{ margin: 0, fontSize: 14, color: "#1e40af" }}>
              Use <code style={ui.code}>indjs create</code> with templates:{" "}
              <code style={ui.code}>
                npx create-indjs my-app --template blog
              </code>
              <br />
          ...
          <div style={ui.section}>
            ...
            <ul style={ui.ul}>
              <li style={ui.li}>
                <a href="/docs/routing" style={{ color: "#0ea5e9" }}>
              ...
              <li style={ui.li}>
                <a href="/docs/styling" style={{ color: "#0ea5e9" }}>
                  Add styling with Tailwind CSS
                </a>
              </li>
              <li style={ui.li}>
                <a href="/docs/ssr-ssg" style={{ color: "#0ea5e9" }}>
