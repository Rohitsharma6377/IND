    ...
    <main style={ui.page}>
      <div style={ui.wrap}>
        <section style={ui.hero}>
          ...
          <nav style={ui.ctas}>
            <a href="/learn" style={ui.btnPrimary}>
              Get Started
            </a>
            <a href="/docs" style={ui.btnSecondary}>
              Documentation
            </a>
            <a href="https://github.com/indjs/indjs" style={ui.btnSecondary}>
              GitHub
            </a>
          </nav>
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
              <span style={{ color: "#10b981" }}>✓</span> Built-in
              Authentication
            </div>
            <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
          ...
          <div style={ui.grid}>
            <article style={ui.card}>
              ...
              <p style={ui.cardDesc}>
                ...
                streaming, and incremental regeneration for optimal performance.
              </p>
            </article>
            <article style={ui.card}>
              <div style={{ fontSize: 12, color: "#0369a1", fontWeight: 600 }}>
              ...
              <p style={ui.cardDesc}>
                ...
                middleware, and advanced patterns. No configuration needed.
              </p>
            </article>
            <article style={ui.card}>
              <div style={{ fontSize: 12, color: "#0369a1", fontWeight: 600 }}>
              ...
              <p style={ui.cardDesc}>
                ...
                authentication, and real-time features out of the box.
              </p>
            </article>
            <article style={ui.card}>
              <div style={{ fontSize: 12, color: "#0369a1", fontWeight: 600 }}>
              ...
              <p style={ui.cardDesc}>
                ...
                styled-components, and custom theming.
              </p>
            </article>
            <article style={ui.card}>
              <div style={{ fontSize: 12, color: "#0369a1", fontWeight: 600 }}>
              ...
              <p style={ui.cardDesc}>
                JWT, OAuth, session-based auth with role-based access control,
            ...
            <article style={ui.card}>
              ...
              <p style={ui.cardDesc}>
                One-click deployment to Vercel, Netlify, AWS, Docker with CI/CD
                pipelines and production optimizations.
              </p>
            </article>
            <article style={ui.card}>
              <div style={{ fontSize: 12, color: "#0369a1", fontWeight: 600 }}>
              ...
              <p style={ui.cardDesc}>
                Comprehensive testing with Vitest, Playwright, mocking
                utilities, and test-driven development patterns.
              </p>
            </article>
            <article style={ui.card}>
              <div style={{ fontSize: 12, color: "#0369a1", fontWeight: 600 }}>
              ...
              <p style={ui.cardDesc}>
                Full TypeScript support, powerful CLI tools, hot reload, and
                rich development experience with zero configuration.
              </p>
            </article>
          </div>
        ...
        >
          <p style={{ margin: 0, fontSize: 14 }}>
            Powered by <strong>INDJS</strong> v1.0.0 • Edit{" "}
            <code>pages/index.jsx</code> to customize
          </p>
