...
export default function Script(props) {
  ...
  React.useEffect(() => {
    ...
    try {
      ...
      if (src) s.src = src;
      if (children) s.textContent = typeof children === 'string' ? children : '';
  ...
  }, [id, src, type, asyncAttr, deferAttr, strategy, onLoad, onError, children]);
  ...
  if (strategy === 'afterInteractive') {
    if (src) {
      return React.createElement('script', { id, src, type, async: asyncAttr, defer: deferAttr, onLoad, onError, ...rest });
    }
    // inline
    return React.createElement('script', { id, type, dangerouslySetInnerHTML: { __html: typeof children === 'string' ? children : '' }, ...rest });
  }
