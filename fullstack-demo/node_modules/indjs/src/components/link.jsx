...
export default function Link({ href, children, prefetch = false, replace = false, scroll = true, onClick, className, style, target, rel, ...rest }) {
  ...
  const relFinal = target === '_blank'
    ? [rel, 'noopener', 'noreferrer'].filter(Boolean).join(' ')
    : rel;
  return React.createElement('a', { href, className, style, target, rel: relFinal, onClick: handleClick, ...rest }, children);
}
