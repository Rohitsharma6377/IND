      ...
      <div style={ui.wrap}>
        <section style={ui.hero}>
          ...
          <div style={{
            ...
            <h2 style={{ fontSize: 18, fontWeight: 600, color: '#0b1220', marginBottom: 12 }}>Quick Links</h2>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 16 }}>
              <a href="/learn" style={{ ...ui.cardLink, display: 'block' }}>🚀 Getting Started Guide</a>
              <a href="/docs/installation" style={{ ...ui.cardLink, display: 'block' }}>📦 Installation</a>
              <a href="/docs/api-routes" style={{ ...ui.cardLink, display: 'block' }}>🔌 API Development</a>
              <a href="/docs/deployment" style={{ ...ui.cardLink, display: 'block' }}>🌐 Deploy Your App</a>
            </div>
          </div>
        </section>
      </div>
