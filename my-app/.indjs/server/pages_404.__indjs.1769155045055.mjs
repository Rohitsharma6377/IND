...
function NotFound() {
  return /* @__PURE__ */ jsxs3("div", { className: "min-h-screen animated-gradient flex items-center justify-center relative overflow-hidden", children: [
    /* @__PURE__ */ jsx25("div", { className: "absolute inset-0 bg-grid-white/[0.05] bg-[size:20px_20px]" }),
    /* @__PURE__ */ jsx25("div", { className: "absolute top-20 left-10 w-72 h-72 bg-purple-500/30 rounded-full blur-[100px]" }),
    /* @__PURE__ */ jsx25("div", { className: "absolute bottom-20 right-10 w-96 h-96 bg-pink-500/30 rounded-full blur-[120px]" }),
    /* @__PURE__ */ jsxs3("div", { className: "relative text-center px-4", children: [
      /* @__PURE__ */ jsxs3("div", { className: "relative", children: [
        /* @__PURE__ */ jsx25("h1", { className: "text-[150px] sm:text-[200px] md:text-[250px] font-black text-white/10 leading-none select-none", children: "404" }),
        /* @__PURE__ */ jsx25("div", { className: "absolute inset-0 flex items-center justify-center", children: /* @__PURE__ */ jsx25("span", { className: "text-6xl sm:text-7xl md:text-8xl", children: "\u{1F680}" }) })
      ] }),
      /* @__PURE__ */ jsx25("h2", { className: "text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4 -mt-8", children: "Page Not Found" }),
      /* @__PURE__ */ jsx25("p", { className: "text-lg sm:text-xl text-white/70 mb-8 max-w-md mx-auto", children: "Oops! Looks like you've ventured into uncharted territory. Let's get you back on track." }),
      /* @__PURE__ */ jsxs3("div", { className: "flex flex-col sm:flex-row gap-4 justify-center", children: [
        /* @__PURE__ */ jsx25(Link, { href: "/", children: /* @__PURE__ */ jsxs3("button", { className: "group w-full sm:w-auto px-8 py-4 bg-white text-gray-900 font-bold rounded-2xl hover:bg-gray-100 transform hover:scale-105 transition-all duration-300 shadow-2xl flex items-center justify-center gap-2", children: [
          /* @__PURE__ */ jsx25("svg", { className: "w-5 h-5", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx25("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" }) }),
          "Go Home"
        ] }) }),
        /* @__PURE__ */ jsx25(Link, { href: "/docs", children: /* @__PURE__ */ jsx25("button", { className: "w-full sm:w-auto px-8 py-4 bg-white/10 backdrop-blur-sm border-2 border-white/30 text-white font-bold rounded-2xl hover:bg-white/20 transition-all duration-300 flex items-center justify-center gap-2", children: "View Documentation" }) })
      ] }),
      /* @__PURE__ */ jsxs3("div", { className: "mt-12 flex flex-wrap gap-4 justify-center text-white/60 text-sm", children: [
        /* @__PURE__ */ jsx25(Link, { href: "/features", children: /* @__PURE__ */ jsx25("span", { className: "hover:text-white transition-colors cursor-pointer", children: "Features" }) }),
        /* @__PURE__ */ jsx25("span", { children: "\u2022" }),
        /* @__PURE__ */ jsx25(Link, { href: "/examples", children: /* @__PURE__ */ jsx25("span", { className: "hover:text-white transition-colors cursor-pointer", children: "Examples" }) }),
        /* @__PURE__ */ jsx25("span", { children: "\u2022" }),
        /* @__PURE__ */ jsx25(Link, { href: "/about", children: /* @__PURE__ */ jsx25("span", { className: "hover:text-white transition-colors cursor-pointer", children: "About" }) }),
        /* @__PURE__ */ jsx25("span", { children: "\u2022" }),
        /* @__PURE__ */ jsx25(
          "a",
          {
