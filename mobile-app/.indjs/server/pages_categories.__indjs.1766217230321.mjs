...
function Categories() {
  ...
  return /* @__PURE__ */ jsx25(scroll_view_default, { className: "flex-1 bg-gradient-to-br from-violet-50 via-purple-50 to-fuchsia-50", children: /* @__PURE__ */ jsxs3(view_default, { className: "px-4 py-8", children: [
    /* @__PURE__ */ jsxs3(view_default, { className: "mb-8", children: [
      /* @__PURE__ */ jsx25(text_default, { className: "text-4xl font-bold bg-gradient-to-r from-violet-600 to-fuchsia-600 bg-clip-text text-transparent mb-2", children: "Categories" }),
      /* @__PURE__ */ jsx25(text_default, { className: "text-gray-600 text-lg", children: "Organize tasks by category" })
    ] }),
    /* @__PURE__ */ jsx25(view_default, { className: "grid grid-cols-2 gap-4 mb-8", children: categories.map((category, index) => /* @__PURE__ */ jsxs3(
      pressable_default,
      {
        className: "bg-white rounded-2xl p-5 shadow-lg hover:shadow-xl transition-all duration-300",
        children: [
          /* @__PURE__ */ jsx25(view_default, { className: `w-14 h-14 bg-gradient-to-r ${category.color} rounded-xl flex items-center justify-center mb-3`, children: /* @__PURE__ */ jsx25(text_default, { className: "text-3xl", children: category.icon }) }),
          /* @__PURE__ */ jsx25(text_default, { className: "text-lg font-bold text-gray-800 mb-1", children: category.name }),
          /* @__PURE__ */ jsxs3(text_default, { className: "text-sm text-gray-600", children: [
            category.count,
            " tasks"
          ] })
        ]
    ...
    /* @__PURE__ */ jsxs3(view_default, { className: "mb-8", children: [
      /* @__PURE__ */ jsx25(text_default, { className: "text-xl font-bold text-gray-800 mb-4", children: "Recent Tasks by Category" }),
      categories.slice(0, 4).map((category, index) => /* @__PURE__ */ jsxs3(view_default, { className: "bg-white rounded-2xl p-5 shadow-lg mb-4", children: [
        /* @__PURE__ */ jsxs3(view_default, { className: "flex flex-row items-center gap-3 mb-3", children: [
          /* @__PURE__ */ jsx25(view_default, { className: `w-10 h-10 bg-gradient-to-r ${category.color} rounded-lg flex items-center justify-center`, children: /* @__PURE__ */ jsx25(text_default, { className: "text-xl", children: category.icon }) }),
          /* @__PURE__ */ jsx25(text_default, { className: "text-lg font-bold text-gray-800", children: category.name })
        ] }),
        /* @__PURE__ */ jsx25(view_default, { className: "space-y-2", children: category.tasks.map((task, taskIndex) => /* @__PURE__ */ jsxs3(view_default, { className: "flex flex-row items-center gap-2 py-2", children: [
          /* @__PURE__ */ jsx25(view_default, { className: "w-5 h-5 rounded border-2 border-gray-300" }),
          /* @__PURE__ */ jsx25(text_default, { className: "text-gray-700", children: task })
        ] }, taskIndex)) })
      ] }, index))
    ] })
  ] }) });
