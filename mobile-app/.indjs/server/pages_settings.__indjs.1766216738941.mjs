    ...
    switch (type) {
      case "toggle":
        return /* @__PURE__ */ jsx25(
          ...
          {
            onPress: onToggle,
            className: `relative w-12 h-7 rounded-full transition-colors duration-300 ${isEnabled ? "bg-violet-600" : "bg-gray-300"}`,
            children: /* @__PURE__ */ jsx25(
              view_default,
              {
                className: `absolute top-1 w-5 h-5 rounded-full bg-white shadow-md transition-transform duration-300 ${isEnabled ? "right-1" : "left-1"}`
              }
            )
          }
        );
      case "select":
        return /* @__PURE__ */ jsxs3(view_default, { className: "flex flex-row items-center gap-2", children: [
          /* @__PURE__ */ jsx25(text_default, { className: "text-sm text-gray-600", children: value }),
          /* @__PURE__ */ jsx25(text_default, { className: "text-gray-400", children: "\u203A" })
        ] });
      default:
        return /* @__PURE__ */ jsx25(text_default, { className: "text-gray-400 text-xl", children: "\u203A" });
    }
  };
  return /* @__PURE__ */ jsxs3(
    pressable_default,
    {
      onPress: type !== "toggle" ? onPress : void 0,
      className: "flex flex-row items-center justify-between py-4 px-5 bg-white rounded-2xl mb-3 shadow-sm hover:shadow-md transition-all duration-300",
      children: [
        /* @__PURE__ */ jsxs3(view_default, { className: "flex flex-row items-center gap-4 flex-1", children: [
          /* @__PURE__ */ jsx25(view_default, { className: "w-10 h-10 rounded-xl bg-gradient-to-br from-violet-100 to-fuchsia-100 flex items-center justify-center", children: /* @__PURE__ */ jsx25(text_default, { className: "text-xl", children: icon }) }),
          /* @__PURE__ */ jsxs3(view_default, { className: "flex-1", children: [
            /* @__PURE__ */ jsx25(text_default, { className: "text-base font-semibold text-gray-800 mb-0.5", children: title }),
            subtitle && /* @__PURE__ */ jsx25(text_default, { className: "text-sm text-gray-500", children: subtitle })
          ] })
        ] }),
        renderRightContent()
      ]
...
var { toggleTheme, setTheme, setAccentColor } = themeSlice.actions;
...
function Settings() {
  ...
  return /* @__PURE__ */ jsxs4(view_default, { className: "flex-1 bg-gradient-to-br from-violet-50 via-purple-50 to-fuchsia-50", children: [
    /* @__PURE__ */ jsx26(view_default, { className: "bg-white shadow-md", children: /* @__PURE__ */ jsxs4(view_default, { className: "px-4 py-4 flex flex-row items-center gap-3", children: [
      /* @__PURE__ */ jsx26(
        pressable_default,
        {
          onPress: () => router.push("/profile"),
          className: "w-10 h-10 rounded-xl bg-gray-100 hover:bg-gray-200 flex items-center justify-center transition-all",
          children: /* @__PURE__ */ jsx26("svg", { className: "w-5 h-5 text-gray-600", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: /* @__PURE__ */ jsx26("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M15 19l-7-7 7-7" }) })
        }
      ),
      /* @__PURE__ */ jsx26(text_default, { className: "text-xl font-bold bg-gradient-to-r from-violet-600 to-fuchsia-600 bg-clip-text text-transparent", children: "Settings" })
    ] }) }),
    /* @__PURE__ */ jsx26(scroll_view_default, { className: "flex-1", children: /* @__PURE__ */ jsxs4(view_default, { className: "px-4 py-6", children: [
      /* @__PURE__ */ jsxs4(view_default, { className: "mb-6", children: [
        /* @__PURE__ */ jsx26(text_default, { className: "text-sm font-bold text-gray-700 mb-3 px-1", children: "APPEARANCE" }),
        /* @__PURE__ */ jsx26(
          SettingItem,
          {
            icon: "\u{1F319}",
      ...
      /* @__PURE__ */ jsxs4(view_default, { className: "mb-6", children: [
        /* @__PURE__ */ jsx26(text_default, { className: "text-sm font-bold text-gray-700 mb-3 px-1", children: "NOTIFICATIONS" }),
        /* @__PURE__ */ jsx26(
          SettingItem,
          {
            icon: "\u{1F4E7}",
            title: "Email Notifications",
            subtitle: "Receive task reminders via email",
            type: "toggle",
      ...
      /* @__PURE__ */ jsxs4(view_default, { className: "mb-6", children: [
        /* @__PURE__ */ jsx26(text_default, { className: "text-sm font-bold text-gray-700 mb-3 px-1", children: "PREFERENCES" }),
        /* @__PURE__ */ jsx26(
          SettingItem,
          {
            icon: "\u{1F4C5}",
      ...
      /* @__PURE__ */ jsxs4(view_default, { className: "mb-6", children: [
        /* @__PURE__ */ jsx26(text_default, { className: "text-sm font-bold text-gray-700 mb-3 px-1", children: "ACCOUNT" }),
        /* @__PURE__ */ jsx26(
          SettingItem,
          {
            icon: "\u{1F510}",
      ...
      /* @__PURE__ */ jsxs4(view_default, { className: "mb-6", children: [
        /* @__PURE__ */ jsx26(text_default, { className: "text-sm font-bold text-gray-700 mb-3 px-1", children: "ABOUT" }),
        /* @__PURE__ */ jsx26(
          SettingItem,
          {
            icon: "\u2139\uFE0F",
      ...
      /* @__PURE__ */ jsxs4(view_default, { className: "mb-6", children: [
        /* @__PURE__ */ jsx26(text_default, { className: "text-sm font-bold text-red-600 mb-3 px-1", children: "DANGER ZONE" }),
        /* @__PURE__ */ jsx26(pressable_default, { className: "flex flex-row items-center justify-center py-4 px-5 bg-red-50 rounded-2xl border-2 border-red-200 hover:bg-red-100 transition-all", children: /* @__PURE__ */ jsx26(text_default, { className: "text-base font-semibold text-red-600", children: "Clear All Data" }) })
      ] })
    ] }) })
  ] });
}
