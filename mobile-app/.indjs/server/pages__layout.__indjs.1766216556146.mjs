...
function BottomNav() {
  ...
  return /* @__PURE__ */ jsx25(view_default, { className: "fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-sm z-50", children: /* @__PURE__ */ jsx25(view_default, { className: "flex flex-row items-center justify-around px-2 py-2 pb-safe", children: navItems.map((item, index) => {
    ...
    return /* @__PURE__ */ jsx25(
      pressable_default,
      {
        ...
        children: /* @__PURE__ */ jsxs3(view_default, { className: `flex items-center justify-center transition-all duration-200`, children: [
          /* @__PURE__ */ jsx25(view_default, { className: `w-10 h-10 rounded-lg flex items-center justify-center mb-1 ${isActive ? "bg-blue-500" : "bg-transparent"}`, children: /* @__PURE__ */ jsx25(text_default, { className: "text-2xl", children: isActive ? item.activeIcon : item.icon }) }),
          /* @__PURE__ */ jsx25(text_default, { className: `text-xs font-medium ${isActive ? "text-blue-600" : "text-gray-600"}`, children: item.label })
        ] })
      },
      index
    );
