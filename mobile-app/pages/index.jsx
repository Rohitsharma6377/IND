  ...
  return (
    <ScrollView className="flex-1">
      <View className="px-4 py-8">
        ...
        <View className="bg-white rounded-2xl shadow-lg overflow-hidden mb-24">
...
// Main Home Component with Tab Navigation
export default function Home() {
  ...
  return (
    <View className="flex-1 bg-gradient-to-br from-violet-50 via-purple-50 to-fuchsia-50">
      {/* Content */}
      ...
      <View className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg z-50">
        <View className="flex flex-row items-center justify-around px-2 py-3">
          {navItems.map((item) => {
